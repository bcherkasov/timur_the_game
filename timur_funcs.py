...
def game():
    ...
    while shit_counter < 10:
        ...
        if mood > 0:
            ...
            print(f'### Настроение ни к черту... Даже Рейнхарт охуел!')
        print()
        ...
        if day % 7 == 0:
            ...
            try:                
                ...
                if int(answer) == story_quests[index]['correct']:
                    ...
                    money += new_money
                    mood += new_mood
                    print(f'Тимур получает {new_money} рублей, и настроение сразу лучше стало! На {new_mood} баллов по шкале Рейнхарта!')
                    print()
                    input('Пизданись головой об клаву, чтобы продолжить...')
                else:
            ...
            new_mood = randrange(10,30,5)
            mood -= new_mood
            print(f'Настроение ухудшилось на -{new_mood} по шкале Рейнхарта!')
            print()
            input('Пизданись головой об клаву, чтобы продолжить...')
